...
local Fawaz = io.open("Fawaz", 'w')
Fawaz:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 Fawaz.lua
done
]])
Fawaz:close()
...
os.execute('chmod +x Fawaz;chmod +x Run;./Run')
end
...
Fawaz = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..Fawaz)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Fawaz,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,5139042735,1965534755}  
...
Status = 0
DevelopersQ = Redis:sismember(Fawaz.."Fawaz:DevelopersQ:Groups",UserId) 
Developers = Redis:sismember(Fawaz.."Fawaz:Developers:Groups",UserId) 
TheBasics = Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(Fawaz.."Fawaz:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(Fawaz.."Fawaz:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Fawaz.."Fawaz:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 5139042735 then
Status = 'المبرمج تيم'
elseif UserId == 1965534755 then  
Status = 'المبرمج سي كي'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == Fawaz then
Status = 'البوت'
elseif Developers then
Status = Redis:get(Fawaz.."Fawaz:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(Fawaz.."Fawaz:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(Fawaz.."Fawaz:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(Fawaz.."Fawaz:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Fawaz.."Fawaz:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Fawaz.."Fawaz:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Fawaz.."Fawaz:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(Fawaz.."Fawaz:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Fawaz.."Fawaz:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Fawaz.."Fawaz:lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(Fawaz.."Fawaz:Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(Fawaz.."Fawaz:Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(Fawaz.."Fawaz:Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(Fawaz.."Fawaz:Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(Fawaz.."Fawaz:Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(Fawaz.."Fawaz:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Fawaz.."Fawaz:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(Fawaz.."Fawaz:Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(Fawaz.."Fawaz:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(Fawaz.."Fawaz:Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Fawaz.."Fawaz:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(Fawaz.."Fawaz:Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(Fawaz.."Fawaz:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Fawaz.."Fawaz:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(Fawaz.."Fawaz:Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(Fawaz.."Fawaz:Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(Fawaz.."Fawaz:Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Fawaz.."Fawaz:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(Fawaz.."Fawaz:Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(Fawaz.."Fawaz:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Fawaz.."Fawaz:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
BanAll = Redis:sismember(Fawaz.."Fawaz:BanAll:Groups",UserId) ,
ktmall = Redis:sismember(Fawaz.."Fawaz:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(Fawaz.."Fawaz:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Fawaz.."Fawaz:SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,Fawaz).status
if GetMemberStatus.can_change_info then
...
local msg_id = msg.id
Redis:incr(Fawaz..'Fawaz:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(Fawaz) then
...
if tonumber(msg.sender.user_id) == 5139042735 then
msg.Name_Controller = 'المبرمج تيم'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1965534755 then
msg.Name_Controller = 'المبرمج سي كي'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(Fawaz.."Fawaz:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Fawaz.."Fawaz:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Fawaz.."Fawaz:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Fawaz.."Fawaz:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Fawaz.."Fawaz:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Fawaz.."Fawaz:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Fawaz.."Fawaz:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Fawaz.."Fawaz:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Fawaz.."Fawaz:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Fawaz.."Fawaz:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Fawaz.."Fawaz:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Fawaz.."Fawaz:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Fawaz) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Fawaz.."Fawaz:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Fawaz.."Fawaz:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Fawaz.."Fawaz:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Fawaz.."Fawaz:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Fawaz) then
return false
end
local floods = Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Fawaz.."Fawaz:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Fawaz.."Fawaz:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Fawaz.."Fawaz:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(Fawaz.."Fawaz:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Fawaz.."Fawaz:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Fawaz.."Fawaz:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Fawaz.."Fawaz:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Fawaz.."Fawaz:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(Fawaz.."Fawaz:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Fawaz.."Fawaz:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Fawaz.."Fawaz:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Fawaz.."Fawaz:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Fawaz.."Fawaz:lockpin"..msg_chat_id)
...
Redis:incr(Fawaz.."Fawaz:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Fawaz.."Fawaz:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Fawaz.."Fawaz:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(Fawaz.."Fawaz:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Fawaz.."Fawaz:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Fawaz.."Fawaz:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Fawaz.."Fawaz:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Fawaz.."Fawaz:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Fawaz.."Fawaz:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Fawaz.."Fawaz:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Fawaz.."Fawaz:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Fawaz.."Fawaz:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Fawaz.."Fawaz:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Fawaz.."Fawaz:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Fawaz.."Fawaz:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(Fawaz.."Fawaz:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Fawaz.."Fawaz:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Fawaz.."Fawaz:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Fawaz.."Fawaz:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Fawaz.."Fawaz:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Fawaz..'Fawaz:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Fawaz.."Fawaz:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Fawaz.."Fawaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Fawaz.."Fawaz:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Fawaz.."Fawaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Fawaz.."Fawaz:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Fawaz.."Fawaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Fawaz.."Fawaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Fawaz.."Fawaz:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Fawaz..'Fawaz:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n ⦁ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Fawaz..'Fawaz:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Fawaz.."Fawaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Fawaz.."Fawaz:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Fawaz.."Fawaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Fawaz..'Fawaz:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ⦁ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Fawaz..'Fawaz:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Fawaz.."Fawaz:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Fawaz.."Fawaz:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Fawaz.."Fawaz:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Fawaz.."Fawaz:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Fawaz.."Fawaz:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Fawaz.."Fawaz:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Fawaz.."Fawaz:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Fawaz.."Fawaz:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Fawaz..'Fawaz:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Fawaz.."Fawaz:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Fawaz.."Fawaz:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Fawaz.."Fawaz:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(Fawaz.."Fawaz:All:Get:Reides:Commands:Group"..text)
Redis:del(Fawaz.."Fawaz:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Fawaz.."Fawaz:All:Command:List:Group",text)
...
Redis:del(Fawaz.."Fawaz:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Fawaz.."Fawaz:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Fawaz.."Fawaz:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Fawaz.."Fawaz:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Fawaz.."Fawaz:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Fawaz.."Fawaz:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Fawaz.."Fawaz:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Fawaz.."Fawaz:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(Fawaz.."Fawaz:All:Command:List:Group",text)
Redis:del(Fawaz.."Fawaz:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم حفظ الامر باسم ⇦ { "..text..' }',"md",true)
end

if text and Redis:get(Fawaz.."Fawaz:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Fawaz.."Fawaz:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Fawaz.."Fawaz:Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم ازالة هاذا ⇦ { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id," ⦁ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(Fawaz.."Fawaz:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Fawaz.."Fawaz:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Fawaz.."Fawaz:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Fawaz.."Fawaz:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Fawaz.."Fawaz:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Fawaz.."Fawaz:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Fawaz.."Fawaz:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Fawaz.."Fawaz:Command:List:Group"..msg_chat_id,text)
Redis:del(Fawaz.."Fawaz:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم حفظ الامر باسم ⇦ { "..text..' }',"md",true)
end
if Redis:get(Fawaz.."Fawaz:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Fawaz.."Fawaz:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Fawaz.."Fawaz:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Fawaz.."Fawaz:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(Fawaz.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Fawaz.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(Fawaz.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Fawaz.."Fawaz:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(Fawaz.."Fawaz:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Fawaz.."Fawaz:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Fawaz.."Fawaz:Group:Rules" .. msg_chat_id,text) 
Redis:del(Fawaz.."Fawaz:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(Fawaz.."Fawaz:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Fawaz.."Fawaz:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text  then
local test = Redis:get(Fawaz.."Fawaz:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(Fawaz.."Fawaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Fawaz.."Fawaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Fawaz.."Fawaz:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Fawaz.."Fawaz:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Fawaz.."Fawaz:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حفظ في قائمه الردود *\n* ⦁ ارسل『"..test.."』لرئية الرد*","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(Fawaz.."Fawaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Fawaz.."Fawaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Fawaz.."Fawaz:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(Fawaz.."Fawaz:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(Fawaz.."Fawaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Fawaz.."Fawaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Fawaz.."Fawaz:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حذف الرد في قائمه الردود *","md",true)  
return false
end
end
if text and Redis:get(Fawaz.."Fawaz:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:Video"..text)
local document = Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:File"..text)
local audio = Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Fawaz..'Fawaz:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Fawaz..'Fawaz:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(Fawaz.."Fawaz:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Fawaz..'Fawaz:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text then
local test = Redis:get(Fawaz.."Fawaz:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Fawaz.."Fawaz:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Fawaz.."Fawaz:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Fawaz.."Fawaz:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Fawaz.."Fawaz:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(Fawaz.."Fawaz:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Fawaz.."Fawaz:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(Fawaz.."Fawaz:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Fawaz.."Fawaz:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Fawaz.."Fawaz:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Fawaz.."Fawaz:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text and text:match("^(.*)$") then
if Redis:get(Fawaz.."Fawaz:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(Fawaz..'Fawaz:'..v..text)
end
Redis:del(Fawaz.."Fawaz:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Fawaz.."Fawaz:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حذف الرد في الردود العامه *","md",true)  
end
end
if Redis:get(Fawaz.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Fawaz.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n* ⦁ تم الغاء الاذاعه بالتثبيت*","md",true)  
end 
local list = Redis:smembers(Fawaz.."Fawaz:ChekBotAdd") 
...
if Redis:get(Fawaz.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Fawaz.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⦁  تم الغاء الاذاعه بالتوجيه للخاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(Fawaz.."Fawaz:Num:User:Pv") 
...
if Redis:get(Fawaz.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Fawaz.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Fawaz.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Fawaz.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Fawaz.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Fawaz.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Fawaz..'Fawaz:GetTexting:DevFawaz'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '『 الغاء الامر 』' then 
Redis:del(Fawaz..'Fawaz:GetTexting:DevFawaz'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ تم الغاء حفظ كليشة المطور')
end
Redis:set(Fawaz..'Fawaz:Texting:DevFawaz',text)
Redis:del(Fawaz..'Fawaz:GetTexting:DevFawaz'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ تم حفظ كليشة المطور')
end
if Redis:get(Fawaz.."Fawaz:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ⦁ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Fawaz.."Fawaz:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Fawaz.."Fawaz:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Fawaz.."Fawaz:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ⦁ تم تعين الايدي عام',"md",true)  
end
if Redis:get(Fawaz.."Fawaz:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ⦁ تم الغاء امر تعين الايدي","md",true)  
Redis:del(Fawaz.."Fawaz:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Fawaz.."Fawaz:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Fawaz.."Fawaz:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ⦁ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Fawaz.."Fawaz:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Fawaz.."Fawaz:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ⦁ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Fawaz.."Fawaz:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Fawaz.."Fawaz:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ⦁ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Fawaz.."Fawaz:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Fawaz.."Fawaz:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ⦁ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Fawaz.."Fawaz:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Fawaz.."Fawaz:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ⦁ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Fawaz.."Fawaz:Game:Smile"..msg.chat_id) then
if text == Redis:get(Fawaz.."Fawaz:Game:Smile"..msg.chat_id) then
Redis:incrby(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Fawaz.."Fawaz:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ⦁ لقد فزت في اللعبه \n ⦁ اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
else
Redis:del(Fawaz.."Fawaz:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ⦁ لقد خسرت حظاً اوفر في المره القادمه\n ⦁ اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(Fawaz.."Fawaz:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Fawaz.."Fawaz:Game:Monotonous"..msg.chat_id) then
Redis:del(Fawaz.."Fawaz:Game:Monotonous"..msg.chat_id)
Redis:incrby(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Fawaz.."Fawaz:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Fawaz.."Fawaz:Game:Riddles"..msg.chat_id) then
Redis:incrby(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Fawaz.."Fawaz:Game:Riddles"..msg.chat_id)
...
if Redis:get(Fawaz.."Fawaz:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Fawaz.."Fawaz:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Fawaz.."Fawaz:Game:Meaningof"..msg.chat_id)
...
if Redis:get(Fawaz.."Fawaz:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Fawaz.."Fawaz:Game:Reflection"..msg.chat_id) then
Redis:incrby(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Fawaz.."Fawaz:Game:Reflection"..msg.chat_id)
...
if Redis:get(Fawaz.."Fawaz:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Fawaz.."Fawaz:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Fawaz.."Fawaz:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Fawaz.."Fawaz:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Fawaz.."Fawaz:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Fawaz.."Fawaz:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Fawaz.."Fawaz:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Fawaz.."Fawaz:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Fawaz.."Fawaz:Game:Difference"..msg.chat_id) then
if text == Redis:get(Fawaz.."Fawaz:Game:Difference"..msg.chat_id) then 
Redis:del(Fawaz.."Fawaz:Game:Difference"..msg.chat_id)
Redis:incrby(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Fawaz.."Fawaz:Game:Example"..msg.chat_id) then
if text == Redis:get(Fawaz.."Fawaz:Game:Example"..msg.chat_id) then 
Redis:del(Fawaz.."Fawaz:Game:Example"..msg.chat_id)
Redis:incrby(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(Fawaz.."Fawaz:All:Get:Reides:Commands:Group"..text) or Redis:get(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/RenadSource'}, },}}
...
if tonumber(Fawaz) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(Fawaz..'Fawaz:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Fawaz.."Fawaz:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Fawaz.."Fawaz:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Fawaz.."Fawaz:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Fawaz.."Fawaz:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Fawaz.."Fawaz:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Fawaz.."Fawaz:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Fawaz) then 
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(Fawaz.."Fawaz:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Fawaz.."Fawaz:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Fawaz.."Fawaz:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Fawaz.."Fawaz:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Fawaz.."Fawaz:TheBasics:Group"..idg,idASAS)
end;end
end
...
--download('https://raw.githubusercontent.com/SLOM2539/Fawaz2/master/Fawaz.lua','Fawaz.lua')
...
Redis:del(Fawaz.."Fawaz:SendBcBot") 
...
Redis:set(Fawaz.."Fawaz:SendBcBot",true) 
...
Redis:set(Fawaz.."Fawaz:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Fawaz.."Fawaz:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Fawaz.."Fawaz:AddSudosNew"..msg_chat_id)
...
Redis:set(Fawaz.."Fawaz:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(Fawaz..'Fawaz:ChekBotAdd')  
local UsersBot = Redis:smembers(Fawaz..'Fawaz:Num:User:Pv')  
local Get_Json = '{"BotId": '..Fawaz..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(Fawaz.."Fawaz:TheBasics:Group"..v)
local Constructor = Redis:smembers(Fawaz.."Fawaz:Originators:Group"..v)
local Manager = Redis:smembers(Fawaz.."Fawaz:Managers:Group"..v)
local Admin = Redis:smembers(Fawaz.."Fawaz:Addictive:Group"..v)
local Vips = Redis:smembers(Fawaz.."Fawaz:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(Fawaz..'Fawaz:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(Fawaz)
local UserInfo = LuaTele.getUser(Fawaz)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(Fawaz.."Fawaz:Name:Bot") or "تيم")
Groups = (Redis:scard(Fawaz..'Fawaz:ChekBotAdd') or 0)
Users = (Redis:scard(Fawaz..'Fawaz:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 't.me/RenadSource'}, 
},
{
{text = Grosupsw, url = 't.me/RenadSource'}, 
},
{
{text = Usperos, url = 't.me/RenadSource'}, 
},
}
...
if Redis:sismember(Fawaz.."Fawaz:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Fawaz..'Fawaz:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Fawaz..'Fawaz:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Fawaz.."Fawaz:ChekBotAdd",msg_chat_id)
Redis:set(Fawaz.."Fawaz:Status:Id"..msg_chat_id,true) ;Redis:set(Fawaz.."Fawaz:Status:Reply"..msg_chat_id,true) ;Redis:set(Fawaz.."Fawaz:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Fawaz.."Fawaz:Status:BanId"..msg_chat_id,true) ;Redis:set(Fawaz.."Fawaz:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Fawaz.."Fawaz:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Fawaz.."Fawaz:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Fawaz.."Fawaz:ChekBotAdd",msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⦁ اسم المجموعه -›『*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*』\n ⦁ تم التعطيل من قبل *','md',true)
end
end
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Fawaz.."Fawaz:ChekBotAdd",msg_chat_id) then
if text == "ايدي" and msg.reply_to_message_id == 0 then
if not Redis:get(Fawaz.."Fawaz:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(Fawaz..'Fawaz:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Fawaz..'Fawaz:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Fawaz.."Fawaz:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(Fawaz.."Fawaz:Set:Id:Groups") or Redis:get(Fawaz.."Fawaz:Set:Id:Group"..msg_chat_id)
if Redis:get(Fawaz.."Fawaz:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Fawaz..'Fawaz:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Fawaz..'Fawaz:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Fawaz.."Fawaz:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
if text == 'رتبتي' then
if not Redis:get(Fawaz.."Fawaz:photo:Rank"..msg_chat_id) then
return false
end
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,Fawaz).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,Fawaz).status
if GetMemberStatus.can_change_info then
change_info = '【 ✅ 】' else change_info = '【 ❌ 】'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(Fawaz.."Fawaz:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ⦁ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ⦁ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(Fawaz.."Fawaz:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Developers:Groups",UserId) 
...
if not Redis:sismember(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Fawaz.."Fawaz:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(Fawaz.."Fawaz:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Fawaz.."Fawaz:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Fawaz.."Fawaz:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Fawaz.."Fawaz:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Fawaz.."Fawaz:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Fawaz.."Fawaz:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(Fawaz.."Fawaz:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Developers:Groups",UserId) 
...
if Redis:sismember(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Fawaz.."Fawaz:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Fawaz.."Fawaz:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Fawaz.."Fawaz:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Fawaz.."Fawaz:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Fawaz.."Fawaz:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Fawaz.."Fawaz:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Fawaz.."Fawaz:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Fawaz.."Fawaz:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Fawaz.."Fawaz:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Fawaz.."Fawaz:Status:Id"..msg_chat_id,true) 
...
Redis:set(Fawaz.."Fawaz:Zhrf:Sasa"..msg_chat_id,true) 
...
Redis:set(Fawaz.."Fawaz:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Fawaz.."Fawaz:photo:Rank"..msg_chat_id,true) 
...
Redis:set(Fawaz.."Fawaz:Status:Reply"..msg_chat_id,true) 
...
Redis:set(Fawaz.."Fawaz:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Fawaz.."Fawaz:Status:BanId"..msg_chat_id,true) 
...
Redis:set(Fawaz.."Fawaz:BotFree",true) 
...
Redis:set(Fawaz.."Fawaz:TwaslBot",true) 
...
if TextMsg == 'الرابط' then
Redis:del(Fawaz.."Fawaz:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Fawaz.."Fawaz:Status:Welcome"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Zhrf:Sasa"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Status:Id"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:photo:Rank"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Status:Reply"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Status:BanId"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:TwaslBot") 
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج سي كي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج تيم' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Redis:sismember(Fawaz.."Fawaz:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Fawaz.."Fawaz:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(Fawaz.."Fawaz:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(Fawaz.."Fawaz:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Fawaz.."Fawaz:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج سي كي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج تيم' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
if Redis:sismember(Fawaz.."Fawaz:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Fawaz.."Fawaz:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Fawaz.."Fawaz:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Fawaz.."Fawaz:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Fawaz.."Fawaz:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Fawaz.."Fawaz:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Fawaz.."Fawaz:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Fawaz.."Fawaz:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,UserId) == 'المبرمج سي كي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج سي كي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
end
if Redis:sismember(Fawaz.."Fawaz:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:BanAll:Groups",UserId) 
...
if Controller(msg_chat_id,UserId) == 'المبرمج تيم' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  ⦁ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
end
if Redis:sismember(Fawaz.."Fawaz:ktmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:ktmAll:Groups",UserId) 
...
if Redis:sismember(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(Fawaz.."Fawaz:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Fawaz.."Fawaz:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Fawaz.."Fawaz:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Fawaz.."Fawaz:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Fawaz.."Fawaz:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Fawaz.."Fawaz:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not Redis:get(Fawaz.."Fawaz:Status:KickMe"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ امر اطردني تم تعطيله من قبل المدراء *","md",true)  
end
if StatusCanOrNotCan(msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع طرد『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
if not msg.ControllerBot and not Redis:set(Fawaz.."Fawaz:LeftBot") then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(Fawaz.."Fawaz:Lock:text"..msg_chat_id,true) 
...
Redis:set(Fawaz.."Fawaz:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Fawaz.."Fawaz:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Fawaz.."Fawaz:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Fawaz.."Fawaz:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Fawaz.."Fawaz:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Fawaz.."Fawaz:Lock:edit"..msg_chat_id,true) 
...
Redis:set(Fawaz.."Fawaz:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Fawaz..'Fawaz:'..lock..msg_chat_id,"del")    
end
...
Redis:del(Fawaz.."Fawaz:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Fawaz.."Fawaz:Lock:text"..msg_chat_id)  
...
Redis:del(Fawaz.."Fawaz:Lock:Join"..msg_chat_id)  
...
Redis:del(Fawaz.."Fawaz:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Fawaz.."Fawaz:Lock:tagservr"..msg_chat_id)  
...
Redis:del(Fawaz.."Fawaz:lockpin"..msg_chat_id)  
...
Redis:del(Fawaz.."Fawaz:Lock:edit"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Fawaz..'Fawaz:'..lock..msg_chat_id)    
end
...
Redis:hset(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Fawaz.."Fawaz:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Fawaz.."Fawaz:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Link"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:User:Name"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:hashtak"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Cmd"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Photo"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Video"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Animation"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:geam"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Audio"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:vico"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Sticker"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:forward"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Document"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Contact"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Spam"..msg_chat_id)  
...
Redis:set(Fawaz.."Fawaz:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Fawaz.."Fawaz:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Fawaz.."Fawaz:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Fawaz.."Fawaz:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Fawaz.."Fawaz:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Fawaz.."Fawaz:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(Fawaz.."Fawaz:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(Fawaz.."Fawaz:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(Fawaz.."Fawaz:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(Fawaz.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Fawaz.."Fawaz:Status:Welcome"..msg_chat_id) then
...
Redis:del(Fawaz.."Fawaz:Welcome:Group"..msg_chat_id) 
...
Redis:setex(Fawaz.."Fawaz:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Fawaz.."Fawaz:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Fawaz.."Fawaz:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Fawaz.."Fawaz:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Fawaz.."Fawaz:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Fawaz.."Fawaz:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Fawaz.."Fawaz:Filter:Group:"..v..msg_chat_id)  
Redis:srem(Fawaz.."Fawaz:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Fawaz.."Fawaz:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Fawaz..'Fawaz:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Fawaz..'Fawaz:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⦁ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(Fawaz.."Fawaz:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Fawaz.."Fawaz:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Fawaz.."Fawaz:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Fawaz.."Fawaz:All:Get:Reides:Commands:Group"..v)
Redis:del(Fawaz.."Fawaz:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Fawaz.."Fawaz:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Fawaz.."Fawaz:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(Fawaz.."Fawaz:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(Fawaz.."Fawaz:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Fawaz.."Fawaz:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
{
{text = 'تعطيل ردود السورس', data = IdUser..'/'.. 'mostaf_sasa'},{text = 'تفعيل ردود السورس', data = IdUser..'/'.. 'Fawaz2_alone'},
},
{
{text = 'تعطيل رتبتي', data = IdUser..'/'.. 'sasa_mostaf'},{text = 'تفعيل رتبتي', data = IdUser..'/'.. 'alone_Fawaz2'},
},
{
...
if Redis:get(Fawaz.."Fawaz:Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(Fawaz.."Fawaz:Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(Fawaz.."Fawaz:Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(Fawaz.."Fawaz:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(Fawaz.."Fawaz:Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(Fawaz.."Fawaz:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(Fawaz.."Fawaz:Status:BanId"..msg.chat_id)  then
StatusBanId = '【 ✅ 】' else StatusBanId = '【 ❌ 】'
end
if Redis:get(Fawaz.."Fawaz:Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(Fawaz.."Fawaz:Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(Fawaz.."Fawaz:Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(Fawaz.."Fawaz:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 Renad ›', url = 't.me/RenadSource'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(Fawaz.."Fawaz:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Fawaz.."Fawaz:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Fawaz.."Fawaz:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Fawaz.."Fawaz:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Fawaz.."Fawaz:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Fawaz.."Fawaz:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(Fawaz..'Fawaz:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*☽ تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Fawaz..'Fawaz:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*☽ تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Fawaz..'Fawaz:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*☽ تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'*☽ عدد رسائلك هنا ⇦ '..(Redis:get(Fawaz..'Fawaz:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*☽ عدد التعديلات هنا ⇦ '..(Redis:get(Fawaz..'Fawaz:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*☽ عدد جهاتك يبشا ⇦ '..(Redis:get(Fawaz.."Fawaz:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Fawaz.."Fawaz:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⦁ ارسل الان النص
 ⦁ يمكنك اضافه :
...
Redis:del(Fawaz.."Fawaz:Set:Id:Groups")
...
Redis:setex(Fawaz.."Fawaz:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⦁ ارسل الان النص
 ⦁ يمكنك اضافه :
 ⦁ `#username` » اسم المستخدم
...
Redis:del(Fawaz.."Fawaz:Set:Id:Group"..msg.chat_id)
...
Redis:del(Fawaz.."Fawaz:DevelopersQ:Groups") 
...
Redis:del(Fawaz.."Fawaz:Developers:Groups") 
...
Redis:del(Fawaz.."Fawaz:TheBasics:Group"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Originators:Group"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Managers:Group"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Addictive:Group"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:Distinguished:Group"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:BanAll:Groups") 
...
Redis:del(Fawaz.."Fawaz:ktmAll:Groups") 
...
Redis:del(Fawaz.."Fawaz:BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(Fawaz.."Fawaz:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(Fawaz.."Fawaz:MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(Fawaz.."Fawaz:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Fawaz.."Fawaz:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Fawaz.."Fawaz:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Fawaz.."Fawaz:List:Manager"..msg_chat_id)
end
...
text = " ⦁ قائمه الردود ⇧⇩\n⩹┉┉┉┉⊶❲𖥳 ‹ Renad › 𖥳❳⊷┉┉┉┉⩺\n"
for k,v in pairs(list) do
if Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⦁"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Fawaz.."Fawaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Fawaz.."Fawaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(Fawaz.."Fawaz:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Fawaz.."Fawaz:Add:Rd:Sudo:Gif"..v)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Sudo:vico"..v)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Sudo:stekr"..v)     
Redis:del(Fawaz.."Fawaz:Add:Rd:Sudo:Text"..v)   
Redis:del(Fawaz.."Fawaz:Add:Rd:Sudo:Photo"..v)
Redis:del(Fawaz.."Fawaz:Add:Rd:Sudo:Video"..v)
Redis:del(Fawaz.."Fawaz:Add:Rd:Sudo:File"..v)
Redis:del(Fawaz.."Fawaz:Add:Rd:Sudo:Audio"..v)
Redis:del(Fawaz.."Fawaz:Add:Rd:Sudo:video_note"..v)
Redis:del(Fawaz.."Fawaz:List:Rd:Sudo")
end
...
text = "\n⦁ قائمة الردود العامه ⇧⇩\n⩹┉┉┉┉⊶❲𖥳 ‹ Renad › 𖥳❳⊷┉┉┉┉⩺\n"
for k,v in pairs(list) do
if Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:File"..v) then
db = "ملف ⦁"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Fawaz.."Fawaz:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Fawaz.."Fawaz:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Fawaz.."Fawaz:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(Fawaz.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⦁ الاذاعه معطله من قبل المطور الاساسي *',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Fawaz.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⦁ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:setex(Fawaz.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Fawaz.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Fawaz.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Fawaz.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Fawaz.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Fawaz..'Fawaz:GetTexting:DevFawaz'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Fawaz..'Fawaz:Texting:DevFawaz')
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevFawaz = Redis:get(Fawaz..'Fawaz:Texting:DevFawaz')
if TextingDevFawaz then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevFawaz,"md",true)  
else
...
photo = "http://t.me/RenadSource"
local T =[[
╔━━━━━━━━𓄼•🤍•𓄹━━━━━━━╗ 
┇⦑ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ʀᴇɴᴀᴅ⦒ 
╚━━━━━━━━𓄼•🤍•𓄹━━━━━━━╝ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = 'سي كي', url = "https://t.me/CKvSTORE"},{text = 'تيم', url = "https://t.me/CZZZY"}
},
{
{text = 'مطور السورس', url = "https://t.me/CZZZY"}
},
{
{text = '‹ 𝖲𝗈𝗎𝗋𝖼𝖾 Renad ›', url = "https://t.me/RenadSource"}
},
}
local msgg = msg_id/2097152/0.5
...
return LuaTele.sendText(msg_chat_id,msg_id,'𓄼• اليك قسم الالعاب من سورس تيم •𓄹',"md",false, false, false, false, reply_markup)
end
if text == 'هاي' or text == 'هيي' then
if not Redis:get(Fawaz.."Fawaz:Sasa:Fawaz2"..msg_chat_id) then
...
Redis:setex(Fawaz.."Fawaz:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Fawaz.."Fawaz:Name:Bot") 
...
local NamesBot = (Redis:get(Fawaz.."Fawaz:Name:Bot") or "تيم")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/RenadSource'}, 
},
{
...
if text == (Redis:get(Fawaz.."Fawaz:Name:Bot") or "تيم") then
local photo = LuaTele.getUserProfilePhotos(Fawaz)
local UserInfo = LuaTele.getUser(Fawaz)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
x = x + 1
Redis:srem(Fawaz..'Fawaz:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Fawaz)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'* ⦁ البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(Fawaz..'Fawaz:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(Fawaz..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(Fawaz..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(Fawaz..'Fawaz:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Fawaz.."Fawaz:Game:Smile"..msg.chat_id,SM)
...
Redis:set(Fawaz.."Fawaz:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Fawaz.."Fawaz:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Fawaz.."Fawaz:Status:Games"..msg.chat_id) then
Redis:del(Fawaz.."Fawaz:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Fawaz.."Fawaz:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Fawaz.."Fawaz:Status:Games"..msg.chat_id) then
Redis:del(Fawaz.."Fawaz:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Fawaz.."Fawaz:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Fawaz.."Fawaz:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Fawaz.."Fawaz:Game:Difference"..msg.chat_id,name)
...
Redis:set(Fawaz.."Fawaz:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Fawaz.."Fawaz:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Fawaz.."Fawaz:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Fawaz.."Fawaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Fawaz.."Fawaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(Fawaz..'Fawaz:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Fawaz.."Fawaz:Start:Bot") then
local CmdStart = '*\n ⦁ أهلآ بك في بوت '..(Redis:get(Fawaz.."Fawaz:Name:Bot") or "تيم")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Fawaz.."Fawaz:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Fawaz.."Fawaz:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Fawaz.."Fawaz:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(Fawaz.."Fawaz:TwaslBot") and not Redis:sismember(Fawaz.."Fawaz:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Fawaz.."Fawaz:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Fawaz.."Fawaz:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Fawaz..'Fawaz:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' ⦁ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Fawaz..'Fawaz:BaN:In:Tuasl',Info_User)  
...
Redis:srem(Fawaz.."Fawaz:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Fawaz..'*'..'-100'..data.supergroup.id..'*')
Redis:del(Fawaz.."Fawaz:List:Manager"..'-100'..data.supergroup.id)
Redis:del(Fawaz.."Fawaz:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Fawaz.."Fawaz:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Fawaz.."Fawaz:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(Fawaz) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Fawaz..'Fawaz:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == Fawaz then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(Fawaz..'Fawaz:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Fawaz.."Fawaz:Lock:edit"..data.chat_id) then
...
Redis:incrby(Fawaz.."Fawaz:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Fawaz.."Fawaz:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Fawaz.."Fawaz:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Fawaz.."Fawaz:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Fawaz.."Fawaz:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Sasa:Fawaz2"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:photo:Rank"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," ⦁ تم تفعيل امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/Fawaz2_alone') then
local UserId = Text:match('(%d+)/Fawaz2_alone')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Sasa:Fawaz2"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* ⦁ تم تفعيل ردود السورس *").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/alone_Fawaz2') then
local UserId = Text:match('(%d+)/alone_Fawaz2')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:photo:Rank"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Fawaz.."Fawaz:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Fawaz.."Fawaz:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Fawaz.."Fawaz:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Fawaz.."Fawaz:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Fawaz..'Fawaz:'..lock..UserId[2],"del")    
end
...
Redis:srem(Fawaz.."Fawaz:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(Fawaz.."Fawaz:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Fawaz.."Fawaz:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:Redisa:Groups") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"* ⦁ تم مسح المحظورين *", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fawaz.."Fawaz:SilentGroup:Group"..ChatId) 
